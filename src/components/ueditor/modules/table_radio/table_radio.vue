...
// 引入表单配置页公共样式
@import '../../less/data-config-style.less';
            ...
            <div class="form-item">
                ...
                <div v-if="dataConfig.labels" class="form-item-cont">
                    <div
                        ...
                        <div class="table-col">
                            <Button  shape="circle" icon="md-add" size="small" @click="labelBtnClick('add', item, i)" title="添加"></Button>
                        </div>
                        <div class="table-col">
                            <Button  shape="circle" icon="md-remove" size="small" @click="labelBtnClick('remove', item, i)" title="删除"></Button>
                        </div>
                    </div> <!-- table-item 结束 -->
                </div>
            </div> <!-- form-item 结束 -->
            ...
            <div class="form-item">
                ...
                <div v-if="dataConfig.rows" class="form-item-cont">
                    <div
                        ...
                        <div class="table-col">
                            <Button  shape="circle" icon="md-add" size="small" @click="rowBtnClick('add', row, i)" title="添加"></Button>
                        </div>
                        <div class="table-col">
                            <Button shape="circle" icon="md-remove" size="small" @click="rowBtnClick('remove', row, i)" title="删除"></Button>
                        </div>
                    </div> <!-- table-item 结束 -->
                </div>
            </div> <!-- form-item 结束 -->
