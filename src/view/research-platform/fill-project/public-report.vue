<template>
  <div class="layout">
    ...
    <research-project v-for="(project,index) in needApplyData.data" :index='index' :key="project.value" :researchProject="project" @on-newResult='getNewResult' need="no"></research-project>
    <Page :showTotal="true" :current='pageNo' :page-size='pageSize' :total="needApplyData.totalRows" @on-change="changePage" style="text-align: center;"></Page>
  </div>
</template>
